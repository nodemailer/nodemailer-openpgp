...
Encrypter.prototype._flush = function (done) {
    ...
    console.log(openpgp.enums.keyStatus); //eslint-disable-line
    pubKeys.forEach(function (key) {
        console.log(key.verifyPrimaryKey()); //eslint-disable-line
    });
    ...
    if (this.options.signingKey) {
        try {
            ...
            console.log(privKey.verifyPrimaryKey()); //eslint-disable-line
    }
